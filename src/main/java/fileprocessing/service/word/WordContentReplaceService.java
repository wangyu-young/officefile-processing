 ...
 * 替换word中的文本
 */
public class WordContentReplaceService {

    public static void WordContentReplace(){
    ...
    private static Map<String,String> loadConfig() throws IOException {
        ...
        XSSFSheet sheet = workbook.getSheet("word文本替换");
        ...
        for (File file : folder.listFiles()) {
            if (file.isDirectory()) {
                ...
                if (fileExtension.equals("docx")) {
                    ...
                    WordContentHignLightUtil.convertWordByXwpf(file.getAbsolutePath(),
                            file.getAbsolutePath().replace("files", "newfiles"), map,false);
                }
            }
        }
    }
